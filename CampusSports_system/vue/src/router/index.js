...
const routes = [
  ...
  // ----------主页---------
  {
    ...
    children:[ // 子路由
      ...
      // ----------Sports---------
      {path: 'sportsList', name: 'SportsList', component: () => import('@/views/sports/List.vue'),},
      {path: 'addSports', name: 'AddSports', component: () => import('@/views/sports/Add.vue'),},
      {path: 'editSports', name: 'EditSports', component: () => import('@/views/sports/Edit.vue'),},
      // ----------Borrow---------
